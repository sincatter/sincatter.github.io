...
const font_providers = {
    ...
    loli_font: 'https://fonts.loli.net/${ type }?family=${ fontname }'
};

const icon_providers = {
    fontawesome: 'https://use.fontawesome.com/releases/v5.4.1/css/all.css',
    bootcdn: 'https://cdn.bootcss.com/font-awesome/5.4.1/css/all.css',
    loli_icon: 'https://cdnjs.loli.net/ajax/libs/font-awesome/5.4.1/css/all.min.css'
};
